            ...
            <form action="{{ route('aprendices.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="Numdoc" class="form-control @error('Numdoc') is-invalid @enderror"
                               value="{{ old('Numdoc') }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="CorreoInstitucional" class="form-control @error('CorreoInstitucional') is-invalid @enderror"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="CorreoPersonal" class="form-control @error('CorreoPersonal') is-invalid @enderror"
